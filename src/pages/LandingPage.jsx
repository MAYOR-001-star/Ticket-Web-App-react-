...
export default function LandingPage() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white min-h-[80vh] flex flex-col justify-center items-center text-center px-6">
      {/* Decorative Circles */}
      <div className="absolute top-10 left-10 w-20 h-20 bg-blue-200 rounded-full blur-2xl opacity-70"></div>
      <div className="absolute bottom-20 right-20 w-32 h-32 bg-blue-300 rounded-full blur-2xl opacity-50"></div>
